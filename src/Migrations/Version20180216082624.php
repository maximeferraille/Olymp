 ...
 */
class Version20180216082624 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE events CHANGE session_date session_date VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE events CHANGE session_date session_date DATETIME NOT NULL');
