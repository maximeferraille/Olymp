 ...
 */
class Version20180216082705 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE events CHANGE start_date_time start_date_time VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE events CHANGE start_date_time start_date_time DATETIME NOT NULL');
